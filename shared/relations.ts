...
import { users, agentSessionContexts, brandOnboarding, agentLearning, claudeConversations, claudeMessages, domains, emailCaptures, generationTrackers, inspirationPhotos, userPersonalBrand, userModels, generatedImages, projects, savedPrompts, selfieUploads, photoSelections, usageHistory, subscriptions, userProfiles, userLandingPages, userSimplifiedProfile, userStyleguides, userUsage, userWebsiteOnboarding, victoriaChats, websites, userStyleMemory, promptAnalysis, aiImages, feedTemplates, brandedPosts, feedCollections, approvalQueue, agentBudgets, agentCostTracking, agentSessions, emailAccounts, instagramMessages, processedEmails, userGeneratedWebsites, websiteBuilderConversations, loraWeights, trainingRuns, imageVariants, generatedVideos, brandAssets, userStyleProfile, liveSessions, liveEvents } from "./schema.js";

// Maya tables from dedicated schema file
import { mayaPersonalMemory, mayaChats, mayaChatMessages, mayaSubscriptions, mayaPayments, mayaUsageTracking, mayaUsageBudgets, mayaProfile, mayaImages, mayaModels, mayaConcepts } from "./schema-maya.js";
