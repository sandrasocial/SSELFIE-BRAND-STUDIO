...
exports.userStyleguides = (0, pg_core_1.pgTable)("user_styleguides", {
    ...
    colorPalette: (0, pg_core_1.jsonb)("color_palette"),
    typography: (0, pg_core_1.jsonb)("typography"),
    imageSelections: (0, pg_core_1.jsonb)("image_selections"),
    brandPersonality: (0, pg_core_1.jsonb)("brand_personality"),
    businessApplications: (0, pg_core_1.jsonb)("business_applications"),
    customizations: (0, pg_core_1.jsonb)("customizations"),
...
exports.styleguideTemplates = (0, pg_core_1.pgTable)("styleguide_templates", {
    ...
    typographySetup: (0, pg_core_1.jsonb)("typography_setup"),
    layoutStructure: (0, pg_core_1.jsonb)("layout_structure"),
    targetPersonality: (0, pg_core_1.jsonb)("target_personality"),
    createdAt: (0, pg_core_1.timestamp)("created_at").defaultNow(),
});
