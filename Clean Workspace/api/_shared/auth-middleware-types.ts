...
import { AuthenticatedUser, AuthenticatedRequest } from './auth-types.js';
...
export type OptionalAuthHandler<T> = (req: AuthenticatedRequest, res: VercelResponse) => Promise<T>;
