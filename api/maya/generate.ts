 ...
 * Vercel Serverless Function - /api/maya/generate * POST /api/maya/generate - Pure Serverless
...
import handler from '../../server/api/maya/generate.js';import { getUserFromRequest } from '../../_utils/auth-helpers.js';
...
export const config = {export const config = { runtime: 'nodejs', maxDuration: 60 };

  runtime: 'nodejs',

  maxDuration: 60,export default async function handler(req: VercelRequest, res: VercelResponse) {
