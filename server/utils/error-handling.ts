...
import { Logger } from "./logger";import { Request, Response, NextFunction } from "express";import { errorHandler } from "./error-handler";"
...
export class ErrorHandlingSystem {
  ...
  constructor() {
  this.logger = new Logger('ErrorHandlingSystem')';  this._isEnabled = true';'
  }
