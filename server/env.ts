...
export const AWS_REGION = process.env['AWS_REGION'] || process.env['AWS_S3_REGION'];
export const AWS_S3_BUCKET = process.env['AWS_S3_BUCKET'] || process.env['AWS_S3_BUCKET_NAME'];
