      ...
      <div className="main-container">
        ...
        <aside className="sidebar">
          <div className="sidebar-section">
            ...
            >
              {isOnboardingMode ? 'Personal Brand Discovery' : 'New Session'}
            </button>
          </div>
          ...
          {isOnboardingMode && onboardingStatus && (
            <div className="sidebar-section">
              <div className="onboarding-progress">
                ...
                <div className="step-indicator">Step {onboardingStatus.currentStep || 1} of 6</div>
              </div>
            </div>
          )}
          ...
          <div className="sidebar-section">
            <div className="sidebar-title">
              {isOnboardingMode ? 'Getting To Know You' : 'Previous Sessions'}
            </div>
        ...
        <main className="chat-area">
          ...
          <div className="chat-header">
            <h1 className="chat-title">
              {isOnboardingMode ? 'Personal Brand Discovery' : 'Maya Studio'}
            </h1>
            <p className="chat-subtitle">
              {isOnboardingMode 
                ? 'Discovering your story and future self vision' 
                : 'Create photos that build your brand'
              }
            </p>
            
            {/* Generation controls - only show when not in onboarding */}
            {!isOnboardingMode && (
                ...
                {messages.map((message, index) => (
                  <div key={index} className={`message ${message.role}`}>
                    ...
                    <div className="message-content">
                      ...
                      {/* Image previews - for regular Maya */}
                      ...
                      {/* Generation button - for regular Maya */}
                      {message.canGenerate && message.generatedPrompt && !isOnboardingMode && (
                ...
                {isTyping && (
                  <div className="typing-indicator">
                    ...
                    <div className="typing-text">
                      {isOnboardingMode ? 'Maya is listening and thinking...' : 'Maya is styling your look...'}
                    </div>
                  </div>
                )}
              ...
              <textarea
                ...
                placeholder={
                  isOnboardingMode 
                    ...
                    : "Tell Maya what kind of photos you want to create..."
                }
                rows={1}
                disabled={isTyping}
                style={{
