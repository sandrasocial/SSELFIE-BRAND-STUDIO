...
/**
 * STABLE ADMIN AGENT SERVER - CommonJS Version
...
const ADMIN_AGENTS = {
  zara: { name: "Zara", role: "Technical Architect & UI/UX Implementation Expert", personality: "Strategic, analytical, systems-focused. Provides architectural insights and technical solutions." },
  elena: { name: "Elena", role: "Project Management & Process Optimization Expert", personality: "Organized, efficient, results-driven. Focuses on workflow optimization and project coordination." },
  olga: { name: "Olga", role: "Data Analysis & AI Model Training Specialist", personality: "Detail-oriented, methodical, data-driven. Excels at analysis and optimization." },
  aria: { name: "Aria", role: "Content Strategy & Brand Voice Expert", personality: "Creative, brand-focused, strategic. Develops compelling content and messaging." },
  quinn: { name: "Quinn", role: "Quality Assurance & Testing Specialist", personality: "Thorough, systematic, quality-focused. Ensures reliability and performance." },
  victoria: { name: "Victoria", role: "Payment Systems & Revenue Optimization Expert", personality: "Business-savvy, growth-oriented, strategic. Optimizes revenue and conversions." },
  rachel: { name: "Rachel", role: "User Experience & Interface Design Expert", personality: "User-centric, intuitive, design-focused. Creates exceptional user experiences." },
  martha: { name: "Martha", role: "Operations & Infrastructure Management Expert", personality: "Reliable, process-oriented, systematic. Ensures smooth operations and stability." },
  diana: { name: "Diana", role: "Security & Compliance Specialist", personality: "Security-focused, compliance-aware, risk-conscious. Protects systems and data." },
  maya: { name: "Maya", role: "Customer Success & Support Expert", personality: "Empathetic, solution-oriented, customer-focused. Ensures user satisfaction and success." },
  sophia: { name: "Sophia", role: "Research & Strategy Development Expert", personality: "Research-driven, strategic, analytical. Develops insights and long-term strategies." },
  ava: { name: "Ava", role: "Performance Optimization & Analytics Expert", personality: "Performance-focused, metrics-driven, optimization-oriented. Maximizes efficiency and results." }
};
...
app.post('/api/admin/consulting-chat', async (req, res) => {
  try {
    ...
    if (!agentId || !message) {
      return res.status(400).json({ success: false, message: 'Agent ID and message required' });
    }
...
app.get('*', (req, res) => {
  res.json({
    ...
    status: 'operational',
    agents: Object.keys(ADMIN_AGENTS).length,
    endpoints: [ '/health', '/api/health', '/api/auth/user', '/api/admin/consulting-chat', '/api/admin/agents' ]
  });
});
