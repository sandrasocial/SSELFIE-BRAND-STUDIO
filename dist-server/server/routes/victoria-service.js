...
function analyzeBusinessGoals(brandData) {
...
function analyzeBusinesFocus(brandData) {
...
function generateRecommendations(brandData) {
...
function generateWebsiteStructure({ brandData, selectedImages, selectedFlatlays }) {
    const goals = analyzeBusinessGoals(brandData);
    const focus = analyzeBusinesFocus(brandData);
    const pages = [
        {
...
function generateServicesSections(brandData, focus) {
    return [
        {
            type: 'text-content',
            content: {
...
function generateContactSections(brandData) {
    return [
        {
            type: 'contact',
            content: {
...
function generateHeadline(brandData, focus) {
...
function generateServices(brandData) {
    const businessType = brandData.businessType?.toLowerCase() || '';
...
function generateAboutPreview(brandData) {
...
function getRecommendedComponents(stylePreference) {
...
function generateLayoutStructure(preferences) {
    if (preferences.stylePreference === 'editorial-luxury') {
        return {
...
function generateDesignSystem(preferences) {
    return {
...
function generateDesignPrinciples(preferences) {
    const principles = [];
    if (preferences.stylePreference === 'editorial-luxury') {
