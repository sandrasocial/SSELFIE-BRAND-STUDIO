...
export class UserService extends BaseService {
     ...
     */
    async getOrCreateUser(stackAuthId, email, displayName, profileImageUrl) {
        try {
            if (!stackAuthId) {
            ...
            const userRecord = await userMigrationService.findOrMigrateUser(stackAuthId, email, displayName || null, profileImageUrl || null);
            if (!userRecord) {
