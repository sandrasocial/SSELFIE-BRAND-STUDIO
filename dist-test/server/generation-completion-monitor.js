        ...
        try {
            ...
            if (predictionData.status === 'succeeded' && predictionData.output) {
                ...
                try {
                    ...
                    const previewMessage = await MayaChatPreviewService.saveChatPreview(chatId, imageUrls, tracker.prompt || 'Maya Editorial Photoshoot', predictionData.id, tracker.userId);
                }
                catch (previewError) {
