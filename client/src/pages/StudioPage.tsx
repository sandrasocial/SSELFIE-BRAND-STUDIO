  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-2 gap-4">
        <button className="bg-neutral-200 text-black px-8 py-6 rounded-xl font-light tracking-wide transition-all duration-200 hover:bg-neutral-300 hover:scale-[1.02] active:scale-[0.98] min-h-[64px] touch-manipulation">
          <Camera className="mx-auto mb-3" size={24} strokeWidth={1.5} />
          NEW SESSION
        </button>
        <button className="bg-neutral-800/40 text-neutral-200 px-8 py-6 rounded-xl font-light tracking-wide border border-neutral-700/30 transition-all duration-200 hover:bg-neutral-800/60 min-h-[64px] touch-manipulation">
