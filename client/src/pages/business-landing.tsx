    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-black text-white overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-5xl px-4 sm:px-6 lg:px-8">
          ...
          <p className="text-lg sm:text-xl md:text-2xl font-light mb-12 max-w-3xl mx-auto leading-relaxed">
            Upload selfies. Receive professional brand photography.<br />
            Never book another photoshoot.
          </p>
          
          <div className="space-y-4 mb-12">
            <p className="text-base text-white/80 italic" style={{ fontFamily: "Times New Roman, serif" }}>
              "The AI photographer that built 120,000 follower brands"
            </p>
          </div>
          ...
          >
            <span className="text-xs uppercase tracking-[0.3em] text-white border-b border-white/30 pb-2 group-hover:border-white transition-all duration-300 font-light">
              BEGIN TRANSFORMATION — €47 MONTHLY
            </span>
          </button>
            ...
            <div className="col-span-12 lg:col-span-7 flex items-center">
              <div className="max-w-2xl">
                ...
                <h2 
                  ...
                  style={{ fontFamily: "Times New Roman, serif" }}
                >
                  Hours spent creating content.<br />
                ...
                <div className="space-y-8">
                  <div className="border-l-2 border-gray-200 pl-6">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Hours searching for lighting, angles, outfits. Multiple takes for one acceptable image.
                    </p>
                  </div>
                  ...
                  <div className="border-l-2 border-gray-200 pl-6">
                    ...
                    <p className="text-gray-600 leading-relaxed">
                      Scrolling through camera roll, reposting the same three images across all platforms.
                    </p>
                  </div>
                  
                  <div className="border-l-2 border-gray-200 pl-6">
                    <h3 className="text-lg font-medium mb-2 text-black">Inconsistent Quality</h3>
                    <p className="text-gray-600 leading-relaxed">
                      Amateur appearance undermines professional credibility and brand perception.
                    </p>
                  </div>
                </div>
                ...
                <div className="mt-12 p-6 bg-gray-50">
                  <p className="text-lg text-black font-medium italic" style={{ fontFamily: "Times New Roman, serif" }}>
                    "Meanwhile, competitors publish consistent professional content daily."
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16 sm:mb-20">
            ...
            <h2 
              ...
              style={{ fontFamily: "Times New Roman, serif" }}
            >
              Professional brand photography<br />
              <span className="italic text-gray-600">in three steps</span>
            </h2>
          ...
          <div className="grid md:grid-cols-3 gap-12 lg:gap-16">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Submit 10-20 selfies from your mobile device. Natural lighting preferred, but not required.
              </p>
              <p className="text-sm text-gray-500 italic">
                Your everyday photographs work perfectly
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Maya AI studies your features and creates professional photography across multiple styles and concepts.
              </p>
              <p className="text-sm text-gray-500 italic">
                Editorial, business, lifestyle, creative direction
              </p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 leading-relaxed mb-4">
                Receive 100+ professional images monthly for comprehensive brand application across all platforms.
              </p>
              <p className="text-sm text-gray-500 italic">
                LinkedIn, Instagram, websites, marketing materials
              </p>
            </div>
          </div>
          ...
          <div className="text-center mt-16 bg-black text-white p-12">
            <p 
              ...
              style={{ fontFamily: "Times New Roman, serif" }}
            >
              "Professional brand photography monthly for the cost of a single dinner"
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="relative py-24 sm:py-32 bg-black text-white overflow-hidden">
        ...
        <div className="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-white/80 mb-12 max-w-2xl mx-auto">
            Upload selfies today. Receive 100+ professional brand photographs within 24 hours.
          </p>
