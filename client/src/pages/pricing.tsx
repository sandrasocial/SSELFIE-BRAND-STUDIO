...
export default function Pricing() {
  ...
  useEffect(() => {
    ...
    if (metaDescription) {
      metaDescription.setAttribute('content', 'Start FREE with 6 AI images/month or upgrade to SSELFIE Studio (€67/month) for 100 AI images, Maya AI chat, and model training.');
    }
    ...
    if (ogDescription) {
      ogDescription.setAttribute('content', 'Choose your plan: FREE (6 AI images/month) or SSELFIE Studio (€67/month) for 100 AI images, Maya AI, and model training.');
    }
    ...
    if (twitterDescription) {
      twitterDescription.setAttribute('content', 'AI personal branding platform. Start FREE with 6 images/month or upgrade to €67/month for 100 images + Maya AI + training.');
    }
    ...
    const structuredData = {
      ...
      "offers": [
        ...
        },
        {
          "@type": "Offer", 
          "name": "SSELFIE Studio",
          "description": "100 AI images per month, Maya AI chat, and model training",
          "price": "67",
          "priceCurrency": "EUR",
          "availability": "https://schema.org/InStock",
