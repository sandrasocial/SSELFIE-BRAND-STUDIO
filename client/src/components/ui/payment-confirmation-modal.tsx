...
interface PaymentConfirmationModalProps {
  ...
  paymentStatus?: 'pre-payment' | 'processing' | 'success' | 'error';
  userData?: UserData;
  onContinue?: () => void;
}
...
export const PaymentConfirmationModal: React.FC<PaymentConfirmationModalProps> = ({
    ...
    return (
      <div className="px-6 py-6 text-center">
        <div className="mb-6">
          ...
          <h3 className="text-xl font-light text-black mb-2" style={{ fontFamily: 'Times New Roman, serif' }}>
            {message.title}
          </h3>
        ...
        <div className="space-y-4 mb-6">
          ...
          <div className="flex justify-between items-center py-2">
            <span className="text-neutral-600 text-sm font-medium">Status</span>
            <span className="text-green-600 text-sm font-medium">✅ Activated</span>
          </div>
        </div>
            ...
            <div>
              ...
              <p className="text-xs text-neutral-600 leading-relaxed">
                {userData?.isAuthenticated 
                  ? "You'll be redirected automatically to continue your journey."
                  : "Complete your secure sign-up to access your subscription."}
              </p>
            </div>
          </div>
        </div>
        ...
        <button
          ...
          className="w-full bg-black text-white px-4 py-3 text-sm font-medium uppercase tracking-wider hover:bg-neutral-800 transition-colors"
        >
          {message.nextStep}
        </button>
      </div>
  ...
  const ErrorView = () => (
    <div className="px-6 py-6 text-center">
      ...
      <div className="flex space-x-3">
        <button
          onClick={onClose}
          className="flex-1 border border-neutral-300 text-neutral-700 px-4 py-2 text-sm font-medium uppercase tracking-wider hover:bg-neutral-100 transition-colors"
        >
          Close
        </button>
        <button
          onClick={onConfirm}
          className="flex-1 bg-black text-white px-4 py-2 text-sm font-medium uppercase tracking-wider hover:bg-neutral-800 transition-colors"
        >
          Try Again
        </button>
      </div>
  ...
  // Render appropriate view based on payment status
