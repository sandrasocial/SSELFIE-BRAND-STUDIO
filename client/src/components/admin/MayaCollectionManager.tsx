  ...
  const getActualCollections = () => [
    ...
    },
    {
      ...
      prompts: [
        ...
        { id: 'milan-fashion-walk', name: 'Milan Fashion District', category: 'Style in Motion', prompt: '[triggerword], woman walking through the fashion capital with innate style where elegance meets everyday, elevated ensemble showcasing Italian sophistication, golden hour lighting illuminating beautiful Italian architecture creating fashion district ambiance, purposeful stride with serene focused expression and effortlessly styled hair, raw photo, visible skin pores, film grain, unretouched natural skin texture, subsurface scattering, photographed on film' },
        { id: 'london-crosswalk-moment', name: 'London Crosswalk', category: 'City Navigation', prompt: '[triggerword], woman navigating the city with quiet confidence in urban moments that feel cinematic, sophisticated British-inspired ensemble creating urban elegance, overcast natural lighting illuminating classic British architecture during street crossing, determined expression while navigating crosswalk with hair moving in city breeze, raw photo, visible skin pores, film grain, unretouched natural skin texture, subsurface scattering, photographed on film' }
      ]
    },
    {
      ...
      prompts: [
        { id: 'morning-coffee-ritual', name: 'Morning Coffee Ritual', category: 'Daily Rituals', prompt: '[triggerword], woman in her morning coffee ritual where life feels like art, elegant morning comfort attire creating cozy sophistication, warm golden sunlight streaming through large kitchen windows illuminating marble countertops during peaceful daily routine, serene expression while holding ceramic mug with steam visible and hair in natural morning waves, raw photo, visible skin pores, film grain, unretouched natural skin texture, subsurface scattering, photographed on film' },
        { id: 'reading-window-light', name: 'Reading by Window', category: 'Quiet Moments', prompt: '[triggerword], woman reading by window in quiet moments that feel cinematic, cozy sophisticated ensemble perfect for relaxed elegance, soft natural afternoon light streaming through sheer curtains creating dreamy illumination, peaceful focused expression while reading with book in lap and hair naturally framing face, raw photo, visible skin pores, film grain, unretouched natural skin texture, subsurface scattering, photographed on film' },
    ...
    },
    {
      ...
      prompts: [
        { id: 'architectural-blazer', name: 'Architectural Power', category: 'Power Suiting', prompt: '[triggerword], woman in architectural power ensemble creating high fashion drama perfect for Vogue, structured executive styling with dramatic silhouette showcasing editorial sophistication, studio lighting with beauty dish and fill creating fashion photography drama, confident expression with sleek hair and strong jawline highlighting architectural fashion, raw photo, visible skin pores, film grain, unretouched natural skin texture, subsurface scattering, photographed on film' },
        { id: 'silk-slip-elegance', name: 'Silk Slip Elegance', category: 'Luxury Minimalism', prompt: '[triggerword], woman in elegant minimalist ensemble creating luxury sophistication perfect for editorial, flowing luxurious styling showcasing understated elegance, soft window light creating gentle shadows and editorial mood, serene expression with natural waves and authentic beauty highlighting refined textures, raw photo, visible skin pores, film grain, unretouched natural skin texture, subsurface scattering, photographed on film' },
