    ...
    <div className={`h-full bg-white ${className} flex`}>
      ...
      <div className="w-1/3 h-full border-r border-gray-200 bg-white flex flex-col">
        ...
        >
          ...
          <TabsContent value="chat" className="flex-1 flex flex-col mt-0 min-h-0 bg-green-100" style={{border: '2px solid green'}}>
            ...
            <div ref={chatContainerRef} className="flex-1 overflow-y-auto p-1 md:p-2 space-y-1 md:space-y-2 min-h-0 bg-blue-100" style={{border: '2px solid blue'}}>
            ...
            <div className="px-1 py-0.5 border-t border-gray-200 flex-shrink-0 bg-red-100" style={{border: '2px solid red'}}>
              <div className="flex space-x-1">
