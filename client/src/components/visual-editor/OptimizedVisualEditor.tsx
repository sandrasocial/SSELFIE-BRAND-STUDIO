...
function CollapsibleCodeBlock({ content }: CollapsibleCodeBlockProps) {
  ...
  // Extract code information for display
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-6xl max-h-[90vh] w-full flex flex-col">
            ...
            <div className="flex-1 overflow-auto p-4">
              <div className="bg-gray-50 rounded p-4 text-sm font-mono overflow-auto">
                <pre className="whitespace-pre-wrap">{content}</pre>
              </div>
            </div>
            <div className="flex items-center justify-between p-4 border-t bg-gray-50">
              <div className="text-xs text-gray-500">
                Code generated by Olga • {new Date().toLocaleString()}
              </div>
              <div className="flex gap-2">
                <button
                  onClick={() => {
