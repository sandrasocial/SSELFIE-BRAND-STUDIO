 ...
 *
 * Lucide React icons work fine at runtime but have complex type definitions.
 * We use 'any' here to suppress type errors while maintaining functionality.
 * The app builds and runs correctly despite these type warnings.
 */

declare module 'lucide-react' {
  // Export all icons as 'any' to suppress type errors
  // These work fine at runtime, the type system just can't fully express them
